 ...
 * @author stevo58008
 */
public class ReturnWithArgsControllableMethodTest extends ControllableMethodTestBase<String, ControllableNonVoidMethod<?, String>> {


    @Override
    protected ControllableNonVoidMethod<?, String> getHistoryInstance() {
        return this.exampleInstanceInUse.getStringReturnMethod_history();
    }
    ...
    protected void executeMethodUnderTest(final Object[] withArgs) {
        ...
        this.exampleInstanceInUse.stringReturnMethod(arg1);
    }
}
